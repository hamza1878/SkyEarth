...
export default function LoginTravelForm({ onSwitch = () => {} }) {
      ...
      <main className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/30">
          <header className="text-center mb-6">
            ...
            <p className="text-sm text-slate-600 mt-2">Sign in to manage your trips & bookings</p>
          </header>
          ...
          <div className="mt-6">
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="text-xs text-slate-500 uppercase">or sign in with</span>
              <span className="h-px w-14 bg-slate-300"></span>
            </div>
